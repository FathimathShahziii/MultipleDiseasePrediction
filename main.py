...
diabetes_model = pickle.load(open("C:/Users/USER/Desktop/PROJECTS/Multiple-Disease-Prediction/sav files/diabetes_model.sav",'rb'))
heart_disease_model = pickle.load(open("C:/Users/USER/Desktop/PROJECTS/Multiple-Disease-Prediction/sav files/heart_disease_model.sav",'rb'))
parkinsons_model = pickle.load(open("C:/Users/USER/Desktop/PROJECTS/Multiple-Disease-Prediction/sav files/parkinsons_model.sav",'rb'))
breast_cancer_model = pickle.load(open("C:/Users/USER/Desktop/PROJECTS/Multiple-Disease-Prediction/sav files/breast_cancer_model .sav", 'rb'))
...
with st.sidebar:
    ...
    selected = option_menu('Multiple Disease Prediction System',
                          ...
                          icons=['droplet','activity','gender-female','person'],
                          default_index=0)
    st.markdown("""
<style>
    .header {
...
if(selected == 'Parkinsons Prediction'):
    ...
    fo = st.text_input('enter fo value')
    fhi = st.text_input('enter fhi value')
    flo = st.text_input('enter flo value')
    Jitter_percent = st.text_input('enter Jitter value')
    Jitter_Abs = st.text_input('enter jitter abs value')
    RAP = st.text_input('enter RAP value')
    PPQ = st.text_input('enter PPQ value')
    DDP = st.text_input('enter DDP value')
    Shimmer = st.text_input('enter Shimmer value')
    Shimmer_dB = st.text_input('enter ShimmerdB value')
    APQ3 = st.text_input('enter APQ3 value')
    APQ5 = st.text_input('enter APQ5 value')
    APQ = st.text_input('enter APQ value')
